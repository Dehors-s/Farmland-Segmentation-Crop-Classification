...
def main():
    # ==================== 参数配置区域 ====================
    # 1. 模型路径
    default_model = r"D:\Work space\DeepLearning\耕地分割\U-NET\best_model.pth" 
    
    # 2. 输入图像路径
    default_input = r"D:\Work space\DeepLearning\耕地分割\data" 
    ...
    # 初始化预测器
    predictor = Predictor(args.model, dropout_rate=args.dropout)
    ...
    mask_dir = out_dir / "masks"          # 存放掩膜图片
    json_dir = out_dir / "json"           # 存放JSON
    vis_dir = out_dir / "visualization"   # 存放矢量化可视化
