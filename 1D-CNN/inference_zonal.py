...
# ================= 1. 配置路径与参数 =================
# 输入文件
SHP_PATH = r"D:\Work space\DeepLearning\耕地分割\data\完整作物边界\作物分布.shp"          # 待预测的矢量文件
TIF_PATH = r"D:\Work space\DeepLearning\耕地分割\data\Sentinel2_TimeSeries_Stack_2023-0000000000-0000000000.tif" # 大尺寸多波段遥感影像
MODEL_PATH = r"D:\Work space\DeepLearning\耕地分割\local_cnn_model.pth"            # 训练好的模型权重

# 输出文件
OUTPUT_SHP = "D:\\Work space\\DeepLearning\\耕地分割\\1D-CNN\\My_Parcels_Result.shp" # 结果保存路径
