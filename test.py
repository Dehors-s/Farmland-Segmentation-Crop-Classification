...
if __name__ == '__main__':
    ...
    model_path = train_pipeline(
        model_type='cnn.gitignore',  # 选择随机森林模型rf (Random Forest) - 随机森林，svm (Support Vector Machine) - 支持向量机，xgboost (XGBoost) - 梯度提升树，lgbm (LightGBM) - 轻量级梯度提升机，深度学习模型-cnn (Convolutional Neural Network) - 卷积神经网络
